...
const test1 = () => {
  ...
  const onCompletePayload = OnPayloadComplet(50)
...
const test2 = () => {
  ...
  const onCompletPayload = OnPayloadComplet()
...
const test3 = () => {
  ...
  const onCompletPayload = OnPayloadComplet(1000)
  const spy = sinonSpy()
...
const test5 = () => {
  ...
  const onCompletPayload = OnPayloadComplet(6);
  const spy = sinonSpy();
