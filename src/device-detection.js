...
const coindDetectorType = al66v();
//Cancelable TimeoutPromise
const timeoutPromise = () => {
    const defferedPromise = {};
    const returnPromise = new Promise((resolve, reject)=>Object.assign(defferedPromise,{resolve,reject}))
    returnPromise.timeout = setTimeout(()=>defferedPromise.reject('timeout'),10000);
