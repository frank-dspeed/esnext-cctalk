import { ReadBufferedResponse } from './on-payload-complet.js'
...
export const al66v = ()=> {
    ...
    const eventsParser = ReadBufferedResponse();
    ...
    const methods = {
        ...
        /** @param {Uint8Array} CCTalkMessage */
        readBufferedCreditEvents(CCTalkMessage,emit=Debug('readBufferedCreditEventsEmit')) {
            const parsedMessage = eventsParser(CCTalkMessage,emit);
            if (parsedMessage) {
